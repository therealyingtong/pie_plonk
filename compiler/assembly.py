...
# Compiles an array of lines, each containing an equation, to assembly
def to_assembly(inp: list[str]) -> list[AssemblyEqn]:
    return [eq_to_assembly(line) for line in inp]
